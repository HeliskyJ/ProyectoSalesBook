 ...
 * @author hely
 */
@WebServlet(name = "ListBook", urlPatterns = {"/listado"})
public class DocList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      List<Documents> list = com.dao.DocumentDao.findAll(numberTwo, numberOne);

        
       request.setAttribute("lis", list);
       request.getRequestDispatcher("salesBookComplete.jsp").forward(request, response);
    }
